...
class TextMes extends StatefulWidget {
  TextMes({super.key, required this.messInfo});
  MessageModel messInfo;
  // Bool checkCurrentUser;

  @override
  _TextMesState createState() => _TextMesState();
}

class _TextMesState extends State<TextMes> {
  @override
